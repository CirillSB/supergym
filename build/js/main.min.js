...
/* harmony import */ var _modules_hide_poster__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/hide-poster */ "./js/modules/hide-poster.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // hidePoster();
  document.addEventListener('keyup', _modules_hide_poster__WEBPACK_IMPORTED_MODULE_8__["hidePoster"]);
  // Modules
  // ---------------------------------
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_hide_poster__WEBPACK_IMPORTED_MODULE_8__["hidePoster"])();
    // initHover();
  });
});
...
/***/ "./js/modules/hide-poster.js":
/*!***********************************!*\
  !*** ./js/modules/hide-poster.js ***!
  \***********************************/
/*! exports provided: hidePoster */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hidePoster", function() { return hidePoster; });
var hidePoster = function hidePoster() {
  var video = document.querySelector('.gym__video');
  var poster = document.querySelector('.gym__video--poster');
  var content = window.getComputedStyle(document.querySelector('.gym__video'), ':after').getPropertyValue('content');
