...
var initCoachersCards = function initCoachersCards() {
  ...
  var canvas = document.querySelector('.coaches');
  var cards = document.querySelectorAll('.slider__nested-list-item');
  var title = document.querySelectorAll('.slider__nested-list-item p');
