...
/* harmony import */ var _modules_initPlayer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/initPlayer */ "./js/modules/initPlayer.js");
/* harmony import */ var _utils_test_webp__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/test-webp */ "./js/utils/test-webp.js");
...
/* harmony import */ var _modules_init_coachers_cards__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/init-coachers-cards */ "./js/modules/init-coachers-cards.js");
/* harmony import */ var _modules_init_dynamic_adaptive__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/init-dynamic-adaptive */ "./js/modules/init-dynamic-adaptive.js");
/* harmony import */ var _modules_set_mask_tel__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/set-mask-tel */ "./js/modules/set-mask-tel.js");
/* harmony import */ var _modules_init_hover__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/init-hover */ "./js/modules/init-hover.js");
...
window.addEventListener('DOMContentLoaded', function () {
  // Utils
  Object(_utils_test_webp__WEBPACK_IMPORTED_MODULE_4__["testWebP"])();
  // ---------------------------------

  Object(_utils_ios_vh_fix__WEBPACK_IMPORTED_MODULE_0__["iosVhFix"])();
  Object(_modules_set_mask_tel__WEBPACK_IMPORTED_MODULE_8__["setMaskTel"])();
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_init_dynamic_adaptive__WEBPACK_IMPORTED_MODULE_7__["initDynamicAdaptive"])();
    ...
    window.form = form;
    form.init();
    Object(_modules_initPlayer__WEBPACK_IMPORTED_MODULE_3__["initPlayer"])();
    Object(_modules_init_coachers_cards__WEBPACK_IMPORTED_MODULE_6__["initCoachersCards"])();
    Object(_modules_init_hover__WEBPACK_IMPORTED_MODULE_9__["initHover"])();
  });
});
...
/***/ "./js/modules/init-coachers-cards.js":
/*!*******************************************!*\
  !*** ./js/modules/init-coachers-cards.js ***!
  \*******************************************/
/*! exports provided: initCoachersCards */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initCoachersCards", function() { return initCoachersCards; });
var initCoachersCards = function initCoachersCards() {
  var image = document.querySelectorAll('.slider__image');
  var gallery = document.querySelector('.slider__inner');
  var canvas = document.querySelector('body');
  var cards = document.querySelectorAll('.slider__item');
  var title = document.querySelectorAll('.slider__item p');
  var cardsDescriptions = document.querySelectorAll('.coaches-card');
  var hideCardsDescriptions = function hideCardsDescriptions() {
    if (window.matchMedia('(max-width: 1199px)').matches) {
      cardsDescriptions.forEach(function (e) {
...
/***/ "./js/modules/init-hover.js":
/*!**********************************!*\
  !*** ./js/modules/init-hover.js ***!
  \**********************************/
/*! exports provided: initHover */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initHover", function() { return initHover; });
var initHover = function initHover() {
  var canvas = document.querySelector('body');
  var gallery = document.querySelector('.coaches');
  ...
  // }
  var hideCard = function hideCard() {
    for (var i = 0; i < cardsDescriptions.length; i++) {
...
var poster = document.querySelector('.gym__video');
var startVideo = function startVideo() {
  player.playVideo();
};
var initPoster = function initPoster() {
  poster.classList.add('gym__video--poster');
};
var changePosterVision = function changePosterVision() {
